<nav x-data="{ open: false }"
    class="bg-dark border-dark shadow dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="flex w-50">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="./images/TheoryUniversity-min.webp" alt="logo th" class="h-9 w-auto img-fluid">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link class="txt-pr" :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                        {{ __('Dashboard') }}
                    </x-nav-link>
                </div>
            </div>
